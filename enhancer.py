...
class FingerprintEnhancer:
    ...
    def compute_energy(self, subbands):
        ...
        # dùng AvgPool để tính tổng năng lượng trong cửa sổ trượt.
        ...
        for subband in subbands:
            ...
            # Tuy nhiên, theo paper "blocks", ta dùng stride nhỏ (ví dụ 4) để trade-off speed/quality
            pad = self.block_size // 2
            # padding=same thi E_k shape sẽ bằng shape ảnh gốc
            E_k = F.avg_pool2d(
                abs_sb, 
    ...
    def enhance(self, image):
        ...
        # Directional Selection & Weighting
        # Eq. 5: w_k = E_k / E_max
        ...
        # Synthesis: Cộng các subbands đã enhance lại
